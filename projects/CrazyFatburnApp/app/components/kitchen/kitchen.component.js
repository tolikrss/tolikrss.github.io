(function () {
    ...
    angular.module('App').component('kitchen', {
        templateUrl: "./app/components/kitchen/kitchen.html",
        controllerAs: 'vm',
        controller: kitchenController
    });

    kitchenController.$inject = ['$scope', '$rootScope', 'ngDialog'];

    function kitchenController($scope, $rootScope, ngDialog) {
        ...
        vm.openInformPopup = function() {
            if (!vm.popupOpened) {
                ...
                var informPopup = ngDialog.open({
                    template: './app/components/kitchen/popupTemplates/informPopup.html',
                    appendClassName: 'kitchen-inform-popup',
                    scope: $scope,
